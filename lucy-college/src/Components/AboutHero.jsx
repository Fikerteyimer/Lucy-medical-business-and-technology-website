...
function AboutHero({
  ...
  return (
    <section
      className="w-full bg-linear-to-br from-blue-50 via-white to-indigo-50 relative overflow-hidden flex items-center md:mt-20"
      style={{ minHeight: height }}
    >
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 -right-40 w-md h-md bg-blue-400/10 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute -bottom-40 -left-40 w-md h-md bg-indigo-400/10 rounded-full blur-3xl animate-pulse delay-1000"></div>
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-lg h-lg bg-cyan-400/5 rounded-full blur-3xl"></div>
        ...
        <div className="max-w-6xl mx-auto px-6 md:px-20">
          ...
          <div className="mt-10 ml-0 md:ml-28 max-w-3xl">
            ...
            <div className="bg-white/80 backdrop-blur-xl p-7 md:p-9 rounded-3xl shadow-xl shadow-blue-500/10 border border-blue-100/80 hover:shadow-2xl hover:shadow-indigo-500/15 hover:scale-[1.01] transition-all duration-500 group">
              ...
              <div className="w-16 h-1 bg-linear-to-r from-blue-500 via-indigo-500 to-blue-400 rounded-full mb-6 group-hover:w-24 transition-all duration-500"></div>
